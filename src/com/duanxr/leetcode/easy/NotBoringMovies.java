...
public class NotBoringMovies {
   ...
   * Please write a SQL query to output movies with an odd numbered ID and a description that is not
   ...
   * +---------+-----------+--------------+-----------+
   */
  String sql = "SELECT * FROM cinema WHERE description != 'boring' HAVING id%2 = 1 ORDER BY rating DESC";
}
