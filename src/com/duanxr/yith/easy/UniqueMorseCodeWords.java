...
public class UniqueMorseCodeWords {
   ...
   * each letter. For example, "cba" can be written as "-.-..--...", (which is the concatenation
  ...
  class Solution {
    ...
    public int uniqueMorseRepresentations(String[] words) {
      ...
      String[] code = new String[]{".-", "-...", "-.-.", "-..", ".", "..-.", "--.", "....", "..",
          ".---", "-.-", ".-..", "--", "-.", "---", ".--.", "--.-", ".-.", "...", "-", "..-",
          "...-", ".--", "-..-", "-.--", "--.."};
      Set<String> transCode = new HashSet<>();
      for (String word : words) {
        char[] chars = word.toCharArray();
        StringBuilder stringBuilder = new StringBuilder();
        for (char c : chars) {
          stringBuilder.append(code[(byte) c - 97]);
        }
        transCode.add(stringBuilder.toString());
      }
